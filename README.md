...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/user-attachments/assets/a8338f68-97bc-4c27-9691-8b19ef3310ea)

![image](https://github.com/user-attachments/assets/593d9b36-ab8d-43e3-a855-50e588aa1be5)


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE):
 ![image](https://github.com/user-attachments/assets/98bb5b3a-f0fd-4d92-8178-8dcb6b6ed2e8)
...
TON = 0.5ms TOFF= 3.5ms TOTAL TIME = 4ms FREQUENCY = 1/(TOTAL TIME) = 0.25Hz

FOR PULSE AT 700

TON = 3.0ms TOFF= 3.2ms TOTAL TIME = 6.2ms FREQUENCY = 1/(TOTAL TIME)= 0.161Hz

FOR PULSE AT 900

TON = 0.8ms TOFF= 7.4ms TOTAL TIME = 8.2ms FREQUENCY = 1/(TOTAL TIME)= 1.21Hz
